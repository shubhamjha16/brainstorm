...
export function ImplementationPlan({ plan, isLoading }: ImplementationPlanProps) {
  ...
  if (!plan) {
    return null; // Don't render anything if there's no plan and not loading (e.g., before generation is triggered)
  }
  ...
  return (
    <Card className="shadow-lg mt-6">
      ...
      <CardContent className="space-y-6">
        <ScrollArea className="h-[calc(100vh-350px)] max-h-[600px] pr-3">
